return {
  ...
  config = function()
    ...
    --- Cmd+P: hidden dotfiles, respects .gitignore (VS Code / Cursor quick open).
    ...
    --- Stricter picker: no hidden dotfiles, respects .gitignore only.
    ...
    vim.keymap.set("n", "<C-p>", quick_open_files, { desc = "Quick open file", noremap = true })
